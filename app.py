...
# app = Flask(__name__)
# app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:root@welcome123/riddle'
# db = SQLAlchemy(app)
...
# @app.route('/write')
# def write():
#     username = "suahmita sarraf"
#     email = "sushmita.sarraf@mail.com"
#     password = "sushmita123"
#     insert_data = CreateTable(username = username, email = email, password = password)
